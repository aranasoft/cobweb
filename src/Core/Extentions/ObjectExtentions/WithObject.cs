...
namespace Cobweb.Extentions.ObjectExtentions {
    public static class WithObject {
        /// <summary>
        ///     Returns the result of a <paramref name="delegate" /> if the <paramref name="object" /> is not null.
        /// </summary>
        /// <example>
        ///     This method may be chained to reduce subsequent null checks.
        ///     <code> parentObject.IfExists(parent => parent.Children).IfExists(children => children.Count()) </code>
        /// </example>
        ...
        /// <returns>
        ///     The result of the <paramref name="delegate" /> or, if the <paramref name="object" /> is null, the default
