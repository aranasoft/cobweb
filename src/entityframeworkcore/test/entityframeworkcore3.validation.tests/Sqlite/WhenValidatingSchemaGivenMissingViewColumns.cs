...
namespace Aranasoft.Cobweb.EntityFrameworkCore.Validation.Tests.Sqlite {
    public class
        WhenValidatingSchemaGivenMissingViewColumns : IClassFixture<SqliteMigrationsFixture<MigrationsMissingViewColumns>> {
        private readonly SqliteMigrationsFixture<MigrationsMissingViewColumns> _fixture;

        public WhenValidatingSchemaGivenMissingViewColumns(SqliteMigrationsFixture<MigrationsMissingViewColumns> fixture) {
            _fixture = fixture;
        }
