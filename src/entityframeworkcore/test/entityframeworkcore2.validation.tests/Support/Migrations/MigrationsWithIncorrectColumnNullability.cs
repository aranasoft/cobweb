...
namespace Aranasoft.Cobweb.EntityFrameworkCore.Validation.Tests.Support.Migrations
{
    ...
    public class MigrationsWithIncorrectColumnNullability : Migration
    {
        public override void Up()
        {
            Create.Table("AspNetRoles")
                .WithColumn("Id", col => col.AsInt32().Nullable().PrimaryKey("PK_AspNetRoles"))
            ...
            Create.Table("AspNetUsers")
                .WithColumn("Id", col => col.AsInt32().Nullable().PrimaryKey("PK_AspNetUsers"))
                .WithColumn("AccessFailedCount", col => col.AsInt32().Nullable())
                .WithColumn("ConcurrencyStamp", col => col.AsStringMax().Nullable())
                .WithColumn("Email", col => col.AsString(256).Nullable())
                .WithColumn("EmailConfirmed", col => col.AsBoolean().Nullable())
                .WithColumn("LockoutEnabled", col => col.AsBoolean().Nullable())
                ...
                .WithColumn("PhoneNumberConfirmed", col => col.AsBoolean().Nullable())
                .WithColumn("SecurityStamp", col => col.AsStringMax().Nullable())
                .WithColumn("TwoFactorEnabled", col => col.AsBoolean().Nullable())
            ...
            Create.Table("AspNetRoleClaims")
                .WithColumn("Id", col => col.AsInt32().Nullable().Identity().PrimaryKey("PK_AspNetRoleClaims"))
                .WithColumn("ClaimType", col => col.AsStringMax().Nullable())
                .WithColumn("ClaimValue", col => col.AsStringMax().Nullable())
                .WithColumn("RoleId",
                    col => col.AsInt32().Nullable()
            ...
            Create.Table("AspNetUserClaims")
                .WithColumn("Id", col => col.AsInt32().Nullable().Identity().PrimaryKey("PK_AspNetUserClaims"))
                .WithColumn("ClaimType", col => col.AsStringMax().Nullable())
                .WithColumn("ClaimValue", col => col.AsStringMax().Nullable())
                .WithColumn("UserId",
                    col => col.AsInt32().Nullable()
            ...
            Create.Table("AspNetUserLogins")
                .WithColumn("LoginProvider", col => col.AsString(450).Nullable().PrimaryKey("PK_AspNetUserLogins"))
                .WithColumn("ProviderKey", col => col.AsString(450).Nullable().PrimaryKey("PK_AspNetUserLogins"))
            ...
            Create.Table("AspNetUserRoles")
                .WithColumn("UserId",
                    col => col.AsInt32().Nullable().PrimaryKey("PK_AspNetUserRoles")
            ...
            Create.Table("AspNetUserTokens")
                .WithColumn("UserId",
                    col => col.AsInt32().Nullable().PrimaryKey("PK_AspNetUserTokens")
                        .ForeignKey("FK_AspNetUserTokens_AspNetUsers_UserId", "AspNetUsers", "Id")
                        .OnDelete(Rule.Cascade))
                .WithColumn("LoginProvider", col => col.AsString(450).Nullable().PrimaryKey("PK_AspNetUserTokens"))
                .WithColumn("Name", col => col.AsString(450).Nullable().PrimaryKey("PK_AspNetUserTokens"))
