...
{
    [Migration(12345, "Add Identity Tables without Indexes")]
    public class MigrationsMissingIndexes : Migration
    {
        public override void Up()
        {
            ...
            Create.Table("AspNetUsers")
                ...
                .WithColumn("NormalizedEmail", col => col.AsString(256).Nullable())
