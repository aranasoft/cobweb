...
namespace Aranasoft.Cobweb.EntityFrameworkCore.Validation.Tests.SqlServer {
    ...
    public class
        WhenValidatingSchemaGivenIncorrectColumnTypes : IClassFixture<
            SqlServerMigrationsFixture<MigrationsWithIncorrectColumnTypes>> {
        private readonly SqlServerMigrationsFixture<MigrationsWithIncorrectColumnTypes> _fixture;

        public WhenValidatingSchemaGivenIncorrectColumnTypes(
            SqlServerMigrationsFixture<MigrationsWithIncorrectColumnTypes> fixture) {
            _fixture = fixture;
        }
        ...
        public void ItShouldOnlyHaveColumnTypeMismatchErrors() {
            ...
            validatingSchema.Should()
                            ...
                            .Which.ValidationErrors
                            .Should()
                            .OnlyContain(error => error.StartsWith("Column type mismatch",
                                                                   StringComparison.InvariantCultureIgnoreCase));
        }
