...
namespace Aranasoft.Cobweb.EntityFrameworkCore.Validation.Tests.Sqlite {
    public class
        WhenValidatingSchemaGivenMissingColumns : IClassFixture<SqliteMigrationsFixture<MigrationsMissingColumns>> {
        private readonly SqliteMigrationsFixture<MigrationsMissingColumns> _fixture;

        public WhenValidatingSchemaGivenMissingColumns(SqliteMigrationsFixture<MigrationsMissingColumns> fixture) {
            _fixture = fixture;
        }
