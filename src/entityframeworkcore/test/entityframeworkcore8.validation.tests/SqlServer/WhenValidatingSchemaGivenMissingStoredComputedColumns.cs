...
public class
    WhenValidatingSchemaGivenMissingStoredComputedColumns : IClassFixture<SqlServerMigrationsFixture<MigrationsMissingStoredComputedColumns>> {
    private readonly SqlServerMigrationsFixture<MigrationsMissingStoredComputedColumns> _fixture;

    public WhenValidatingSchemaGivenMissingStoredComputedColumns(SqlServerMigrationsFixture<MigrationsMissingStoredComputedColumns> fixture) {
        _fixture = fixture;
    }
